            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            <label for="roles_id" class="col-md-4 col-form-label text-md-end">{{ __('Seleccionar Cargo') }}</label>
                        
                            <div class="col-md-6">
                                <select id="roles_id" class="form-control @error('roles_id') is-invalid @enderror" name="roles_id" required>
                                    <option value="">Seleccione un rol</option>
                                    <option value="1" {{ old('roles_id') == 1 ? 'selected' : '' }}>Admin</option>
                                    <option value="2" {{ old('roles_id') == 2 ? 'selected' : '' }}>Vendedor</option>
                                </select>
